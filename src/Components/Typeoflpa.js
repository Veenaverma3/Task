    ...
    <div className="flex  bg-gradient-to-r from-orange-100 to-green-50 flex-col items-center justify-center bg-gray-100 mt-10 mb-16 p-4">
      <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
        ...
        <div className="space-y-4">
          <button className="w-full border-2 border-gray-300 text-gray-700 text-lg font-medium p-4 rounded-lg hover:bg-gray-200 transition">
            Property and Financial Affairs
          </button>
          <button className="w-full bg-teal-100 border-2 border-teal-600 text-teal-700 text-lg font-medium p-4 rounded-lg hover:bg-teal-200 transition">
            Health and Welfare
          </button>
        </div>
      </div>
